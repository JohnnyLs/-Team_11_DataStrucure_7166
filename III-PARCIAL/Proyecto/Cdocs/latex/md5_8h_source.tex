...
\DoxyCodeLine{50 \textcolor{keyword}{class }\mbox{\hyperlink{class_m_d5}{MD5}}}
\DoxyCodeLine{51 \{}
\DoxyCodeLine{52 \textcolor{keyword}{public}:}
\DoxyCodeLine{53   \textcolor{keyword}{typedef} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} \mbox{\hyperlink{class_m_d5_aa836972700679dbcff6ae8337f6db464}{size\_type}}; \textcolor{comment}{// must be 32bit}}
\DoxyCodeLine{54  }
\DoxyCodeLine{55   \mbox{\hyperlink{class_m_d5_afa6155ec36de415ab2dcf5e54b670d13}{MD5}}();}
\DoxyCodeLine{56   \mbox{\hyperlink{class_m_d5_afa6155ec36de415ab2dcf5e54b670d13}{MD5}}(\textcolor{keyword}{const} std::string\& text);}
\DoxyCodeLine{57   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_m_d5_ac5ddf6cd8f940422396d321ea90ed045}{update}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} *buf, \mbox{\hyperlink{class_m_d5_aa836972700679dbcff6ae8337f6db464}{size\_type}} length);}
\DoxyCodeLine{58   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_m_d5_ac5ccba375539b993958fb235f8ac849c}{update}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *buf, \mbox{\hyperlink{class_m_d5_aa836972700679dbcff6ae8337f6db464}{size\_type}} length);}
\DoxyCodeLine{59   \mbox{\hyperlink{class_m_d5}{MD5}}\& \mbox{\hyperlink{class_m_d5_a10f607494a3f2e3e515fc4b99d1a06cc}{finalize}}();}
\DoxyCodeLine{60   std::string \mbox{\hyperlink{class_m_d5_aaf466f683b4bd8b1b66544f48bf09608}{hexdigest}}() \textcolor{keyword}{const};}
\DoxyCodeLine{61   \textcolor{keyword}{friend} std::ostream\& \mbox{\hyperlink{class_m_d5_a18cb04ba932bf64a61be07b38e43fd1f}{operator<<}}(std::ostream\&, \mbox{\hyperlink{class_m_d5}{MD5}} \mbox{\hyperlink{md5_8h_a92c6eed2e9b51298af559aff6792770b}{md5}});}
\DoxyCodeLine{62  }
...
\DoxyCodeLine{70   \textcolor{keyword}{static} \textcolor{keywordtype}{void} decode(uint4 output[], \textcolor{keyword}{const} uint1 input[], \mbox{\hyperlink{class_m_d5_aa836972700679dbcff6ae8337f6db464}{size\_type}} len);}
\DoxyCodeLine{71   \textcolor{keyword}{static} \textcolor{keywordtype}{void} encode(uint1 output[], \textcolor{keyword}{const} uint4 input[], \mbox{\hyperlink{class_m_d5_aa836972700679dbcff6ae8337f6db464}{size\_type}} len);}
\DoxyCodeLine{72  }
...
\DoxyCodeLine{89 \};}
\DoxyCodeLine{90  }
\DoxyCodeLine{91 std::string \mbox{\hyperlink{md5_8h_a92c6eed2e9b51298af559aff6792770b}{md5}}(\textcolor{keyword}{const} std::string str);}
\DoxyCodeLine{92  }
